...
enum StatusOptions { Confirmed, Pending, Completed }
                     ...
                     .ItemTemplate(new DataTemplate(() => new Grid {
                        ...
                        .RowSpan(3),
                          ...
                          new HorizontalStackLayout {
                              Children = {
                                 new Label()
                                .Font(size: 11)
                                .Bind(Label.TextProperty, nameof(ClaimDto.Time), convert: (DateTime value) => value.ToString("dd-MMM-yyyy")),
                                 new Label()
                                .Font(size: 11)
                                .Text(".")
                                .Margins(3, 0, 3, 0),
                        ...
                        new Label()
                         ...
                         new Label { TextColor = Colors.Grey }
                            .Font(size: 22)
                            .Bind(Label.TextProperty, nameof(ClaimDto.Amount), convert: (decimal value) => "₦" + string.Format("{0:N0}", value))
                            .MinWidth(105)
                            .Row(SectionLevel.First)
                            .RowSpan(3)
...
public partial class ClaimViewModel : BaseViewModel {
    ...
    [ObservableProperty]
    private ObservableCollection<ClaimDto> _items;

    [ObservableProperty]
    private ObservableCollection<ClaimDto> _selected;
    ...
    private void Load() {
        Items = new ObservableCollection<ClaimDto>() {
            ...
            new ClaimDto("Spectranet 4G max", "Internet", 30000, DateTime.Now.AddDays(-3), "20GB Packages")
        };
    }
}
